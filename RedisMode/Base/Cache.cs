...
{
    public abstract class Cache<T>:ICache<T> where T:Entity
    {
        protected static readonly ILog Log = LogManager.GetLogger(typeof(Cache<T>).Name);
        ...
        public void Set(string key, T objectToCache, TimeSpan? expiry = null)
        {
